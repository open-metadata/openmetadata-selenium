...
public class TagsPageTest {
    ...
    public void editTagCategoryDescription() throws InterruptedException {
        openTagsPage();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()[contains(.,'"+ tagCategoryDisplayName +"')]] ")));// Select the created listed team
        webDriver.findElement(By.xpath("//*[text()[contains(.,'"+ tagCategoryDisplayName +"')]] ")).click();// Select the created listed team
    ...
    public void addTag() throws InterruptedException {
        openTagsPage();
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[text()[contains(.,'"+ tagCategoryDisplayName +"')]] ")));// Select the created listed team
        webDriver.findElement(By.xpath("//*[text()[contains(.,'"+ tagCategoryDisplayName +"')]] ")).click();// Select the created listed team
    ...
    public void changeTagDescription() throws InterruptedException {
        openTagsPage();
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.xpath("//*[text()[contains(.,'"+ tagCategoryDisplayName +"')]] ")))).click();// Select the created listed team
    ...
    public void addAssociatedTag() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='associatedTagName']")))).click();
        for (int i = 0; i <=1; i ++){
            wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='associatedTagName']")))).sendKeys("P");
            wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='list-item']")))).click();
        }
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='saveAssociatedTag']")))).click();
    }
    ...
    public void addTagToTableColumn() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@data-testid='search-container']//div//div[10]//div//div//h6")));
        ...
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='associatedTagName']")))).click();
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='associatedTagName']")))).sendKeys(tagCategoryDisplayName + "." + tagDisplayName);
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='list-item']")))).click();
        wait.until(ExpectedConditions.elementToBeClickable(webDriver.findElement(By.cssSelector("[data-testid='saveAssociatedTag']")))).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-testid='menu-button'][id='menu-button-Settings']")));
        webDriver.findElement(By.cssSelector("[data-testid='menu-button'][id='menu-button-Settings']")).click(); // Setting
